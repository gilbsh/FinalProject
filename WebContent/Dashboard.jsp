				...
				<div class="tabbable" id="tabs-430508">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="panel-1">
							...
							<div class="input-group">
								<span class="input-group-addon">Filter</span> <input
									id="filter1" type="text" class="form-control"
						...
						<div class="tab-pane" id="panel-2">
							...
							<table class="table table-striped table-hover">
								...
								<tbody ID="searchable2">
									<c:forEach items="${vehiclesMaintenance}"
										var="vehicleMaintenance">
						...
						<div class="tab-pane" id="panel-3">
							...
							<div class="input-group">
								<span class="input-group-addon">Filter</span> <input
									id="filter3" type="text" class="form-control"
									placeholder="Type here...">
							</div>
							<table class="table table-striped table-hover">
								<thead>
