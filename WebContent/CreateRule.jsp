			...
			<form role="form" action="CreateRuleServlet" method="post">
				<div class="col-md-3 column">
					...
					<div class="form-group">
						<label for="ruleName">Rule Name</label><input required
							class="form-control" id="ruleName" name="ruleName">
					</div>
					<div class="form-group">
						<label for="ruleDescription">Rule Description</label><input
							required class="form-control" id="ruleDescription"
					...
					<div class="tabbable" id="tabs-420867">
						<div class="tab-content">
							<div class="tab-pane active" id="dtcRules">
								<div class="form-group">
									<label for="ruleParameter">Rule Parameter</label><br> <select
								...
								<div class="row clearfix">
									<div class="col-md-4 column">
										<div class="form-group">
											<label for="ruleValuen" ID="ruleLowValueLable">Low
												Value</label> <input required type="number" class="form-control"
												name="ruleLowValue" ID="ruleLowValue" min="0" value="0">
										</div>
									</div>
									<div class="col-md-4 column">
										<div class="form-group">
											<label for="ruleValuen" ID="ruleHighValueLable">High
												Value</label> <input required type="number" class="form-control"
												ID="ruleHighValue" name="ruleHighValue" min="0" value="0">
										</div>
									</div>
								</div>
							</div>
							<div class="tab-pane" id="parameterRules">
								...
								<div class="form-group">
									...
									<div>
										<select id="chooseDtc" name="dtc[]" multiple="multiple"
